    ...
    public partial class frm_QuanlyPhieudieutri : Form
    {
        ...
        private void ModifyCommmands()
        {
            ...
            try
            {
               ...
               cmdConfirm.Enabled = cmdUpdate.Enabled = cmdDelteAssign.Enabled = objLuotkham != null && grdAssignDetail.RowCount > 0 && objPhieudieutri != null; // && IsValidCommon();

                cmdSuagoiDV.Enabled = cmdXoagoiDV.Enabled = objLuotkham != null  && Utility.isValidGrid(grdGoidichvu) && (noitruHienthiGoidichvuTheophieudieutri == "0" || (noitruHienthiGoidichvuTheophieudieutri == "1" && objPhieudieutri != null));
                cmdSuaphieuVT_tronggoi.Enabled = cmdXoaphieuVT_tronggoi.Enabled
                    = cmdInphieuVT_tronggoi.Enabled = objLuotkham != null && Utility.isValidGrid(grdVTTH_tronggoi) && Utility.isValidGrid(grdGoidichvu) && (noitruHienthiGoidichvuTheophieudieutri == "0" || (noitruHienthiGoidichvuTheophieudieutri == "1" && objPhieudieutri != null));

                cmdXoachandoan.Enabled =
                cmdSuachandoan.Enabled = objLuotkham != null && Utility.isValidGrid(grdChandoan) && (noitruHienthiChandoankcbTheophieudieutri == "0" || (noitruHienthiChandoankcbTheophieudieutri == "1" && objPhieudieutri != null));

                cmdXoaphieuVT.Enabled =
                  cmdSuaphieuVT.Enabled = objLuotkham != null && Utility.isValidGrid(grdVTTH) && (noitruHienthiPhieuvtthTheophieudieutri == "0" || (noitruHienthiPhieuvtthTheophieudieutri == "1" && objPhieudieutri != null));
                ...
                {
                    cmdThemchandoan.Enabled = objLuotkham != null && (noitruHienthiChandoankcbTheophieudieutri == "0" || (noitruHienthiChandoankcbTheophieudieutri == "1" && objPhieudieutri != null));
                    cmdInsertAssign.Enabled = objLuotkham != null  && objPhieudieutri != null;
                    cmdThemgoiDV.Enabled = objLuotkham != null && IsValidCommon() && (noitruHienthiGoidichvuTheophieudieutri == "0" || (noitruHienthiGoidichvuTheophieudieutri == "1" && objPhieudieutri != null));
                    cmdThemphieuVT_tronggoi.Enabled = objLuotkham != null  && Utility.isValidGrid(grdGoidichvu);
                    cmdThemphieuVT.Enabled = objLuotkham != null && (noitruHienthiPhieuvtthTheophieudieutri == "0" || (noitruHienthiPhieuvtthTheophieudieutri == "1" && objPhieudieutri != null));
            ...
            try
            {
                ...
                else
                {
                    foreach (GridEXRow row in grdAssignDetail.GetCheckedRows())
                    {
                        ...
                        Utility.SetMsg(lblMsg,
                            string.Format("Bạn vừa hủy chuyển CLS thành công"),
                            false);
                    }
                }
            }
