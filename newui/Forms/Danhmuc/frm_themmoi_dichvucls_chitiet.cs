...
namespace VNS.HIS.UI.DANHMUC
{
    public partial class frm_themmoi_dichvucls_chitiet : Form
    {
        ...
        public frm_themmoi_dichvucls_chitiet()
        {
            ...
            txtppvocam._OnShowData += txtppvocam__OnShowData;
            txtloaipttt._OnShowData += txtloaipttt__OnShowData;
        }
        ...
        {
            var _DMUC_DCHUNG = new DMUC_DCHUNG(txtloaipttt.LOAI_DANHMUC);
            _DMUC_DCHUNG.ShowDialog();
            if (!_DMUC_DCHUNG.m_blnCancel)
            {
                string oldCode = txtloaipttt.myCode;
                txtloaipttt.Init();
                txtloaipttt.SetCode(oldCode);
                txtloaipttt.Focus();
            }
        }
        ...
        {
            var _DMUC_DCHUNG = new DMUC_DCHUNG(txtppvocam.LOAI_DANHMUC);
            _DMUC_DCHUNG.ShowDialog();
            if (!_DMUC_DCHUNG.m_blnCancel)
            {
                string oldCode = txtppvocam.myCode;
                txtppvocam.Init();
                txtppvocam.SetCode(oldCode);
                txtppvocam.Focus();
            }
        }
        ...
        private void getData()
        {
            ...
            if (objDichVuChitiet != null)
            {
                ...
                txtloaipttt.SetCode(objDichVuChitiet.LoaiPttt);
                txtppvocam.SetCode(objDichVuChitiet.PpVocam);

                if (objDichVuChitiet.NgayKetthuc == null)
                {
                    dtpNgayCongBo.IsNullDate = true;
                }
                else
                {
                    dtpNgayCongBo.Value = Convert.ToDateTime(objDichVuChitiet.NgayCongbo);
                }
                if (objDichVuChitiet.NgayBatdau == null)
                {
        ...
        private void ProcessData(int serviceDetailId)
        {
            ...
            dr[DmucDichvuclsChitiet.Columns.LoaiPttt] = txtloaipttt.myCode;
            dr[DmucDichvuclsChitiet.Columns.PpVocam] = txtppvocam.myCode;
        ...
        private void Update()
        {
            try
            {
                ...
                objDichVuChitiet.MaPhuongphapthu = txtPhuongphapthu.myCode;
                objDichVuChitiet.NhomInphoiBHYT = txtNhominphoiBHYT.myCode;
                objDichVuChitiet.LoaiPttt = txtloaipttt.myCode;
                objDichVuChitiet.PpVocam = txtppvocam.myCode;
                objDichVuChitiet.NgayCongbo = dtpNgayCongBo.Value;
                objDichVuChitiet.NgayBatdau = dtpNgayHieuLuc.Value;
                objDichVuChitiet.NgayKetthuc = dtpNgayKetthuc.Value;
                objDichVuChitiet.SoluongChitieu = (int) Utility.DecimaltoDbnull(txtsoluongchitieu.Text, 0);
