    ...
    public partial class frm_ChuyenPhongkham : Form
    {
        ...
        void cmdChuyen_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    THU_VIEN_CHUNG.Log(this.Name, globalVariables.UserName, string.Format("Chuyển bệnh nhân {0} từ phòng khám {1} sang phòng {2}", objDangkyKcb_Cu.MaLuotkham, txtPhonghientai.Text, txtPhongkham.Text), action.Update, "");
