    ...
    public partial class frm_KCB_THAMKHAM : Form
    {
        ...
        private void cmdChuyenPhong_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!chuyenPhongkham.m_blnCancel)
                {
                    ...
                    if (arrDr.Length > 0)
                    {
                        arrDr[0]["ten_phongkham"] = chuyenPhongkham.txtPhongkham.Text;
                        arrDr[0]["id_phongkham"] = chuyenPhongkham._DmucDichvukcb.IdPhongkham;
        ...
        private void BenhAnDaithaoduong()
        {
            try
            {
                ...
                frm.uc_bant_41.txtkbChanDoanRaVien.Text = icdName;
                frm.uc_bant_41.txtkbMa.Text = icdCode;
                frm.uc_bant_41.txtBenhChinh.Text = icdChinhName + icdChinhCode;
                frm.uc_bant_41.txtBenhPhu.Text = icdPhuName + icdPhuCode;
                var _KcbBenhAn =
                    new Select().From(KcbBenhAn.Schema).
        ...
        private void CauHinhThamKham()
        {
            ...
            {
                uiStatusBar1.VisualStyle = PropertyLib._AppProperties._StatusVisualStyle;
            }
        }
        ...
        private void AddAutoComplete_m_strMaLuotkham()
        {
            try
            {
                ...
                foreach (DataRow dr in dtMStrMaLuotkham.Rows)
                {
        ...
        private void FillDynamicValues(int idDichvuChitiet, int idchidinhchitiet)
        {
            try
            {
                ...
                DataTable dtData = clsHinhanh.GetDynamicFieldsValues(idDichvuChitiet, txtMauKQ.myCode, "", "", -1,
                                                                     idchidinhchitiet);
                var lnkViewImage = new LinkLabel {Text = @"Xem hình ảnh", Tag = idchidinhchitiet};
        ...
        private void lnkViewImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (objChitiet != null)
                {
                    ...
                    {
                        var viewImages = new frm_ViewImages(objChitiet);
        ...
        private void LayThongTinQuaMaLanKham()
        {
            ...
            if (arrPatients.GetLength(0) <= 0)
            {
                ...
                {
                    var frm = new frm_DSACH_BN_TKIEM(Args);
        ...
        private bool IN_TTAT_DTRI_NGOAITRU()
        {
            ...
            //    THU_VIEN_CHUNG.CreateXML(sub_dtData, "sub_report.xml");
                ...
                if (vDtData != null)
                {
                    ...
                    {
                        List<int> lstKho =
                            dsData.Tables[0].AsEnumerable().Select(c => c.Field<int>("id_kho")).Distinct().ToList();
                        List<byte> listtutuc =
                            dsData.Tables[0].AsEnumerable().Select(c => c.Field<byte>("tu_tuc")).Distinct().ToList();
            ...
            try
            {
                ...
                THU_VIEN_CHUNG.Log(Name, globalVariables.UserName,
                                   string.Format(
                                       ...
                                       idChitietDichvu, objLuotkham.MaLuotkham, objLuotkham.IdBenhnhan), action.Delete);
        ...
        private void cmdPrintAssign_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    actionResult = KcbInphieu.InTachToanBoPhieuCls((int) objLuotkham.IdBenhnhan,
        ...
        private void ThemMoiDonThuoc()
        {
            try
            {
                ...
                frm.em_Action = action.Insert;
                frm.objLuotkham = objLuotkham;
                frm.KcbChandoanKetluan = _KcbChandoanKetluan;
                ...
                if (!frm.m_blnCancel)
                {
                    ...
                    if (frm.KcbChandoanKetluan != null)
                        _KcbChandoanKetluan = frm.KcbChandoanKetluan;
                    Laythongtinchidinhngoaitru();
                    ...
                    if (objLuotkham != null)
                    {
                        ...
                        if (objPrescription != null)
                        {
                            ...
                            if (!frm.m_blnCancel)
                            {
                                ...
                                txtChanDoan._Text = frm._Chandoan;
                                dt_ICD_PHU = frm.dt_ICD_PHU;
                                if (frm.KcbChandoanKetluan != null) _KcbChandoanKetluan = frm.KcbChandoanKetluan;
                                Laythongtinchidinhngoaitru();
                                Utility.GotoNewRowJanus(grdPresDetail, KcbDonthuocChitiet.Columns.IdDonthuoc,
                                                        Utility.sDbnull(frm.txtPres_ID.Text));
                            }
            ...
            foreach (GridEXRow gridExRow in grdPresDetail.GetCheckedRows())
            {
                ...
                int i =
                    m_dtPresDetail.Select(KcbDonthuocChitiet.Columns.IdChitietdonthuoc + " = " + vIdChitietdonthuoc +
                                          ...
                                          KcbDonthuocChitiet.Columns.TrangThai + " >= 1)").Count();
        ...
        private bool IsValidSelectedAssignDetail()
        {
            ...
            int j = m_dtAssignDetail.Select(KcbChidinhclsChitiet.Columns.IdChitietchidinh + " = " + idChidinhchitiet +
                             " And " + KcbChidinhclsChitiet.Columns.TrangthaiThanhtoan + " = 1").Count();
            if (j > 0)
            {
                b_Cancel = true;
            ...
            idChidinhchitiet =
                Utility.Int32Dbnull(
                    grdAssignDetail.CurrentRow.Cells[KcbChidinhclsChitiet.Columns.IdChitietchidinh].Value,
                    -1);
            int k = m_dtAssignDetail.Select(KcbChidinhclsChitiet.Columns.IdChitietchidinh + " = " + idChidinhchitiet +
                                           " And " + KcbChidinhclsChitiet.Columns.TrangThai + " >= " + trangthaixoacls).Count();
            if (k > 0)
            {
                b_Cancel = true;
            }
        ...
        private void txtChieucao_Leave(object sender, EventArgs e)
        {
            ...
            {
                txtibm.Text =
                    Utility.sDbnull(Utility.DecimaltoDbnull(txtCannang.Text, 0)/ ((Utility.DecimaltoDbnull(txtChieucao.Text, 0) /100)*
