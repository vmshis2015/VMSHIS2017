...
namespace VNS.HIS.UI.NGOAITRU
{
    public partial class frm_KCB_DSACH_BNHAN : BaseForm
    {
        ...
        {
            ModifyCommand();
            DataTable dtNhomin = globalVariables.gv_dtNhomInCLS;// THU_VIEN_CHUNG.LayDulieuDanhmucChung("NHOM_INPHIEU_CLS", true);
            ...
            AllowTextChanged = true;
        //    mnuupdatengaykham.Visible = Utility.Coquyen("kcb_suathongtin_benhnhan");
