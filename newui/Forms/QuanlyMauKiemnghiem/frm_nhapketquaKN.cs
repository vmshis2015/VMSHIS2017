        ...
        void SearchData()
        {
            try
            {
                ...
                if (dtChidinh != null && dtChidinh.Rows.Count > 0)
                {
                    ...
                    txtPatient_Name.Text = Utility.sDbnull(dtChidinh.Rows[0][VKcbLuotkham.Columns.TenBenhnhan], "");
                    txtDiaChi.Text = Utility.sDbnull(dtChidinh.Rows[0][VKcbLuotkham.Columns.DiaChi], "");
