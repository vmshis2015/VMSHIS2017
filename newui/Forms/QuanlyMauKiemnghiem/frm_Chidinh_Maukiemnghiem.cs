    ...
    public partial class frm_Chidinh_Maukiemnghiem : Form
    {
        ...
        private void GetData()
        {
            ...
            if (objKcbChidinhcls != null)
            {
                ...
                if (objKcbChidinhcls.NgayTao != null) dtRegDate.Value = objKcbChidinhcls.NgayTao.Value;
            ...
            if (objLuotkham != null)
            {
                if (objBenhnhan != null)
                {
                    if (objBenhnhan.NamSinh != null)
                        this.Text = @"Chỉ định dịch vụ kiểm nghiệm cho:" + objBenhnhan.TenBenhnhan
        ...
        private DataTable m_Danhsachmauchidinh = new DataTable();
        /// <summary>
        ...
        private void InitData()
        {
            try
            {
                ...
                m_Danhsachmauchidinh =
                    new Select().From(DmucDichvucl.Schema)
                        .Where(DmucDichvucl.Columns.LaDvuKiemnghiem)
                        .IsEqualTo(1)
                        .ExecuteDataSet()
                        .Tables[0];
                txtMaukiemnghiem.Init(m_Danhsachmauchidinh, new List<string>() { DmucDichvucl.Columns.IdDichvu, DmucDichvucl.Columns.MaDichvu, DmucDichvucl.Columns.TenDichvu });
        ...
        private void txtMaukiemnghiem__OnSelectionChanged()
        {
            if (Utility.Int16Dbnull(txtMaukiemnghiem.MyID, -1) > 0)
            {
                ...
                txtChitieuphantich.Init(m_dtDanhsachDichvuCLS,
                    new List<string>()
                {
