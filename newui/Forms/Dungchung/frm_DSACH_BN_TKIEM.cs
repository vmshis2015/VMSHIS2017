...
namespace VNS.HIS.UI.Forms.Cauhinh
{
    public partial class frm_DSACH_BN_TKIEM : Form
    {
        ...
        string _args = "ALL";
        public frm_DSACH_BN_TKIEM(string args)
        {
            this._args = args;
            InitializeComponent();
        ...
        void TimKiemThongTin(bool theongay)
        {
            try
            {
              ...
              DataTable  mDtPatient = new KCB_DANGKY().KcbTiepdonTimkiemBenhnhan(theongay ? (chkByDate.Checked ? dtmFrom.Value.ToString("dd/MM/yyyy") : "01/01/1900") : "01/01/1900",
                    theongay ? (chkByDate.Checked ? dtmTo.Value.ToString("dd/MM/yyyy") : "01/01/1900") : "01/01/1900",
                                                     ...
                                                     (byte)cboTrangthainoitru.SelectedValue,
