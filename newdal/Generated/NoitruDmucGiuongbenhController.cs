...
namespace VNS.HIS.DAL
{
    ...
    public partial class NoitruDmucGiuongbenhController
    {
	    ...
	    public void Insert(string MaGiuong,string TenGiuong,short IdKhoanoitru,short IdBuong,decimal GiaDichvu,decimal? GiaBhyt,decimal? PhuthuDungtuyen,decimal? PhuthuTraituyen,decimal? GiaKhac,short SonguoiToida,string MotaThem,string MaDonvitinh,byte? TrangThai,byte? TthaiTunguyen,byte? DangSudung,short? SttHthi,string TenBhyt,string MaBhyt)
	    {
