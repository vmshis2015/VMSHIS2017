...
namespace VNS.HIS.DAL
{
	...
	public partial class TThuocCapphatChitiet : ActiveRecord<TThuocCapphatChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long varIdCapphat,int varIdThuoc,int varSoLuong)
		{
		...
		/// </summary>
		public static void Update(long varIdCtiet,long varIdCapphat,int varIdThuoc,int varSoLuong)
		{
			TThuocCapphatChitiet item = new TThuocCapphatChitiet();
