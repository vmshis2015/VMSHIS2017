	...
	public partial class KcbPhieuchuyenvien : ActiveRecord<KcbPhieuchuyenvien>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarSoChuyentuyen.DataType = DbType.Int64;
				colvarSoChuyentuyen.MaxLength = 0;
		...
		[Bindable(true)]
		public long SoChuyentuyen 
		{
			get { return GetColumnValue<long>(Columns.SoChuyentuyen); }
		...
		/// </summary>
		public static void Insert(long varSoChuyentuyen,long varIdBenhnhan,string varMaLuotkham,DateTime varNgayChuyenvien,short varIdBenhvienChuyenden,string varDauhieuCls,string varKetquaXnCls,string varMabenh,string varChanDoan,string varThuocSudung,string varTrangthaiBenhnhan,string varLydoChuyen,string varHuongDieutri,string varPhuongtienChuyen,string varTenNguoichuyen,int? varIdKhoanoitru,int? varIdBuong,int? varIdGiuong,int? varIdRavien,byte varNoiTru,short? varIdBacsiChuyenvien,DateTime varNgayTao,string varNguoiTao,string varIpMaytao,string varNguoiSua,DateTime? varNgaySua)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieu,long varSoChuyentuyen,long varIdBenhnhan,string varMaLuotkham,DateTime varNgayChuyenvien,short varIdBenhvienChuyenden,string varDauhieuCls,string varKetquaXnCls,string varMabenh,string varChanDoan,string varThuocSudung,string varTrangthaiBenhnhan,string varLydoChuyen,string varHuongDieutri,string varPhuongtienChuyen,string varTenNguoichuyen,int? varIdKhoanoitru,int? varIdBuong,int? varIdGiuong,int? varIdRavien,byte varNoiTru,short? varIdBacsiChuyenvien,DateTime varNgayTao,string varNguoiTao,string varIpMaytao,string varNguoiSua,DateTime? varNgaySua)
		{
			KcbPhieuchuyenvien item = new KcbPhieuchuyenvien();
