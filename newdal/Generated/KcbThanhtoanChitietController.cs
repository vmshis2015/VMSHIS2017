...
namespace VNS.HIS.DAL
{
    ...
    public partial class KcbThanhtoanChitietController
    {
	    ...
	    public void Update(long IdChitiet,long IdThanhtoan,string MadoituongGia,decimal? PtramBhytGoc,decimal PtramBhyt,decimal? SoLuong,decimal DonGia,decimal BnhanChitra,decimal BhytChitra,decimal PhuThu,byte TuTuc,int IdPhieu,int IdPhieuChitiet,int IdDichvu,int IdChitietdichvu,string TenChitietdichvu,string TenBhyt,string DonviTinh,int? SttIn,int? IdKhoakcb,short? IdPhongkham,short? IdBacsiChidinh,byte IdLoaithanhtoan,string TenLoaithanhtoan,string MaDoituongKcb,string KieuChietkhau,decimal? TileChietkhau,decimal? TienChietkhau,byte? TrangthaiHuy,byte? TrangthaiBhyt,byte? TrangthaiChuyen,byte? TinhChiphi,byte NoiTru,int? IdGoi,byte? TrongGoi,long? IdKham,byte? NguonGoc,long? IdThanhtoanhuy,long? IdLichsuDoituongKcb,string MatheBhyt,DateTime NgayTao,string NguoiTao)
	    {
		    KcbThanhtoanChitiet item = new KcbThanhtoanChitiet();
	        item.MarkOld();
	        item.IsLoaded = true;
