...
namespace VNS.HIS.DAL
{
	...
	public partial class TPhieuNhapxuatthuocChitiet : ActiveRecord<TPhieuNhapxuatthuocChitiet>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(long varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,short varThangDu,int varSoLuong,int? varSluongChia,string varSoLo,decimal? varChietKhau,decimal? varThanhTien,decimal? varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varMotaThem,string varKieuThuocvattu,byte? varCoBhyt,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
		...
		/// </summary>
		public static void Update(long varIdPhieuchitiet,long varIdPhieu,DateTime varNgayHethan,int varIdThuoc,decimal varGiaNhap,decimal varGiaBan,decimal? varDonGia,short varThangDu,int varSoLuong,int? varSluongChia,string varSoLo,decimal? varChietKhau,decimal? varThanhTien,decimal? varVat,long? varIdThuockho,long? varIdChuyen,string varMaNhacungcap,string varMotaThem,string varKieuThuocvattu,byte? varCoBhyt,decimal? varGiaBhyt,decimal? varGiaBhytCu,decimal? varGiaPhuthuDungtuyen,decimal? varGiaPhuthuTraituyen,DateTime? varNgayNhap,string varSoDky,string varSoQdinhthau)
		{
			TPhieuNhapxuatthuocChitiet item = new TPhieuNhapxuatthuocChitiet();
