...
namespace VNS.HIS.NGHIEPVU.THUOC
{
    ...
    public class XuatThuoc
    {
                ...
                using (TransactionScope scope = new TransactionScope())
                {
                    ...
                    foreach (KcbDonthuocChitiet objDetail in lstDetail)
                    {
                        ...
                        StoredProcedure sp = SPs.ThuocXuatkho(Utility.Int32Dbnull(objTThuockho.IdKho),
                            ...
                            PropertyLib._HisDuocProperties.XoaDulieuKhiThuocDaHet ? 1 : 0, ErrMsg);
        ...
        public ActionResult LinhThuocBenhNhan(long presId, Int16 idKho, DateTime ngaythuchien)
        {
            try
            {
                string ErrMsg = "";
                using (TransactionScope scope = new TransactionScope())
                {
                    using (SharedDbConnectionScope dbScope = new SharedDbConnectionScope())
                    {
                        ...
                        StoredProcedure spxbenhnhan = SPs.SpTPhieuXuatthuocBenhnhanInsert(objXuatBnhan.IdPhieu,
                        ...
                        foreach (KcbDonthuocChitiet objDetail in lstDetail)
                        {
                            ...
                            objThuocCt.IdChitietdonthuoc = Utility.Int32Dbnull(objDetail.IdChitietdonthuoc);
                            objThuocCt.IdDonthuoc = Utility.Int32Dbnull(objDetail.IdDonthuoc);
                            StoredProcedure spxuatthuoctheodon = SPs.SpTXuatthuocTheodonInsert(objThuocCt.IdPhieuXuat,
                                ...
                                objThuocCt.IdChitietdonthuoc, objThuocCt.IdDonthuoc, ngaythuchien);
        ...
        public DataTable GetObjThuocKhoCollection(int id_kho, int id_thuoc, int id_thuockho, decimal so_luong, byte id_loaidoituong_kcb, byte Dungtuyen, byte Noitru)
        {
            //Lấy thuốc trong kho
        ...
        private void UpdateXuatChiTietBN(KcbDonthuoc objDonthuoc, KcbDonthuocChitiet objDetail, TThuockho objTThuockho, decimal iSoLuonTru, TPhieuXuatthuocBenhnhan objPhieuXuatBnhan)
        {
            using (var scope = new TransactionScope())
            {
                using (var dbsope = new SharedDbConnectionScope())
                {
                    ...
                    StoredProcedure spxtchitiet = SPs.SpTPhieuXuatthuocBenhnhanChitietInsert(objXuatBnhanCt.IdPhieuChitiet,
                    ...
                    StoredProcedure spbiendong = SPs.SpTBiendongThuocInsert(objNhapXuat.IdBiendong, objNhapXuat.MaPhieu,
                ...
                using (var Scope = new TransactionScope())
                {
                    using (var dbScope = new SharedDbConnectionScope())
                    {
                        ...
                        foreach (TPhieuNhapxuatthuocChitiet objPhieuNhapCt in objPhieuNhapCtCollection)
                        {
                            ...
                            ActionResult kiemtrathuocxacnhan = Kiemtrathuocxacnhan(objPhieuNhap, objPhieuNhapCt, ref errMsg);
                    ...
                    foreach (KcbDonthuocChitiet objDetail in lstDetail)
                    {
                        ...
                        foreach (TPhieuXuatthuocBenhnhanChitiet PhieuXuatBnhanCt in objXuatBnhanCtCollection)
                        {
                            ...
                            StoredProcedure sp = SPs.ThuocNhapkhoOutput(PhieuXuatBnhanCt.NgayHethan, PhieuXuatBnhanCt.GiaNhap, PhieuXuatBnhanCt.GiaBan,
                                                              ...
                                                              PhieuXuatBnhanCt.IdThuockho.Value, id_Thuockho_new, PhieuXuatBnhanCt.NgayNhap, PhieuXuatBnhanCt.GiaBhyt, Utility.DecimaltoDbnull(PhieuXuatBnhanCt.PhuthuDungtuyen,0),
                                                              Utility.DecimaltoDbnull(PhieuXuatBnhanCt.PhuthuTraituyen, 0), objDonthuoc.KieuThuocvattu);
                            sp.Execute();
                            //Lấy đầu ra iTThuockho nếu thêm mới để update lại presdetail
                            id_Thuockho_new = Utility.Int32Dbnull(sp.OutputValues[0]);
                            ///xóa thông tin bảng chi tiết
