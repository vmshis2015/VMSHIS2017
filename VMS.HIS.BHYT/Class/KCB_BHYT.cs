...
namespace VMS.HIS.BHYT.Class
{
    public class KCB_BHYT
    {
        ...
        private bool ProcessCreateXml4210(string maluotKham, string _path)
        {
            _sLocalPath = _path;
            ...
            using (XmlWriter xmlWriter917Xml1 = XmlWriter.Create(sbXml1, _xmlWriterSettings))
            {
                ...
                xmlWriter917Xml1.WriteElementString("MIEN_CUNG_CT", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["MIEN_CUNG_CT"]));
                ...
                //    xmlWriter917Xml1.WriteElementString("MUC_HUONG", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["MUC_HUONG"]));
                ...
                xmlWriter917Xml1.WriteElementString("T_TONGCHI", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["T_TONGCHI"]));
                xmlWriter917Xml1.WriteElementString("T_BNCCT", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["T_BNCCT"]));
                ...
                xmlWriter917Xml1.WriteElementString("MA_KHUVUC", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["MA_KHUVUC"], ""));
                xmlWriter917Xml1.WriteElementString("MA_PTTT_QT", Utility.sDbnull(_dtXml.Tables[0].Rows[0]["MA_PTTT_QT"], ""));
            ...
            if (_dtXml.Tables[1].Rows.Count > 0)
            {
                ...
                using (XmlWriter xmlWriter917Xml2 = XmlWriter.Create(sbXml2, _xmlWriterSettings))
                {
                    ...
                    foreach (DataRow row in _dtXml.Tables[1].Rows)
                    {
                        ...
                        xmlWriter917Xml2.WriteElementString("TT_THAU", Utility.sDbnull(row["TT_THAU"]));
                        xmlWriter917Xml2.WriteElementString("PHAM_VI", Utility.sDbnull(row["PHAM_VI"]));
                        ...
                        xmlWriter917Xml2.WriteElementString("MUC_HUONG", Utility.sDbnull(row["MUC_HUONG"]));
                        xmlWriter917Xml2.WriteElementString("T_NGUONKHAC", Utility.sDbnull(row["T_NGUONKHAC"]));
                        xmlWriter917Xml2.WriteElementString("T_BNTT", Utility.sDbnull(row["T_BNTT"]));
                        xmlWriter917Xml2.WriteElementString("T_BHTT", Utility.sDbnull(row["T_BHTT"]));
                        xmlWriter917Xml2.WriteElementString("T_BNCCT", Utility.sDbnull(row["T_BNCCT"]));
                        xmlWriter917Xml2.WriteElementString("T_NGOAIDS", Utility.sDbnull(row["T_NGOAIDS"]));
            ...
            if (_dtXml.Tables[2].Rows.Count > 0)
            {
                ...
                using (XmlWriter xmlWriter917Xml3 = XmlWriter.Create(sbXml3, _xmlWriterSettings))
                {
                    ...
                    foreach (DataRow row in _dtXml.Tables[2].Rows)
                    {
                        ...
                        xmlWriter917Xml3.WriteElementString("GOI_VTYT", Utility.sDbnull(row["GOI_VTYT"]));
                        xmlWriter917Xml3.WriteStartElement("TEN_VAT_TU");
                        xmlWriter917Xml3.WriteCData(Utility.sDbnull(row["TEN_VAT_TU"]));
                        ...
                        xmlWriter917Xml3.WriteElementString("PHAM_VI", Utility.sDbnull(row["PHAM_VI"]));
                        ...
                        xmlWriter917Xml3.WriteElementString("TT_THAU", Utility.sDbnull(row["TT_THAU"]));
                        ...
                        xmlWriter917Xml3.WriteElementString("T_TRANTT", Utility.sDbnull(row["T_TRANTT"]));
                        xmlWriter917Xml3.WriteElementString("MUC_HUONG", Utility.sDbnull(row["MUC_HUONG"]));
                        xmlWriter917Xml3.WriteElementString("T_NGUONKHAC", Utility.sDbnull(row["T_NGUONKHAC"]));
                        xmlWriter917Xml3.WriteElementString("T_BNTT", Utility.sDbnull(row["T_BNTT"]));
                        xmlWriter917Xml3.WriteElementString("T_BHTT", Utility.sDbnull(row["T_BHTT"]));
                        xmlWriter917Xml3.WriteElementString("T_BNCCT", Utility.sDbnull(row["T_BNCCT"]));
                        xmlWriter917Xml3.WriteElementString("T_NGOAIDS", Utility.sDbnull(row["T_NGOAIDS"]));
                        xmlWriter917Xml3.WriteElementString("MA_KHOA", Utility.sDbnull(row["MA_KHOA"]));
                        xmlWriter917Xml3.WriteElementString("MA_GIUONG", Utility.sDbnull(row["MA_GIUONG"]));
        ...
        private bool ProcessCreateXml917(string maluotKham, string _path)
        {
            _sLocalPath = _path;
            if (!Directory.Exists(_sLocalPath)) Directory.CreateDirectory(_sLocalPath);
            _xmlWriterSettings = new XmlWriterSettings
        ...
        public bool ProcessCreateXml(string maluotKham, string path, int congvan)
        {
            try
            {
                bool kt = false;
                if (congvan == 1)
                {
                    kt =   ProcessCreateXml917(maluotKham, path);
                }
                else
                {
                    if (congvan == 2)
                    {
                        ProcessCreateXml917(maluotKham, path);
                    }
                    else
                    {
                        kt = ProcessCreateXml4210(maluotKham, path);
                    }
