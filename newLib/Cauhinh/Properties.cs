...
namespace VNS.Properties
{
    public class AppProperties
    {
        public AppProperties()
        {
            ...
            _PanelVisualStyle = PanelVisualStyle.Office2003;
            _StatusVisualStyle = VisualStyle.Office2003;
        }

        [Browsable(true), ReadOnly(false), Category("Cấu hình ứng dụng"),
         Description("Chọn kiểu hiển thị giao diện Panel"),
         DisplayName(@"Chọn kiểu hiển thị giao diện Panel")]
        public PanelVisualStyle _PanelVisualStyle { get; set; }

        [Browsable(true), ReadOnly(false), Category("Cấu hình ứng dụng"),
         Description("Chọn kiểu hiển thị giao diện Status"),
         DisplayName(@"Chọn kiểu hiển thị giao diện Status")]
        public VisualStyle _StatusVisualStyle { get; set; }
    ...
    public class QMSPrintProperties
    {
        ...
        {
            get { return MauB1.Name; }
            set { MauB1 = Color.FromName(value); }
        }
        ...
        {
            get { return MauF1.Name; }
            set { MauF1 = Color.FromName(value); }
        }
        ...
        {
            get { return MauB2.Name; }
            set { MauB2 = Color.FromName(value); }
        }
        ...
        {
            get { return MauF2.Name; }
            set { MauF2 = Color.FromName(value); }
        }
        ...
        {
            get { return MauB3.Name; }
            set { MauB3 = Color.FromName(value); }
        }
        ...
        {
            get { return MauF3.Name; }
            set { MauF3 = Color.FromName(value); }
        }
    }
    ...
    public class KCBProperties
    {
        ...
        [Browsable(true), ReadOnly(false), Category("Cấu hình Xóa đăng ký khám"),
         Description(
             "True=Cho phép xóa đăng ký khám cùng các chỉ định CLS+Đơn thuốc nếu như chưa được thanh toán.False= không cho phép xóa nếu đã có đơn thuốc hoặc chỉ định CLS"
             ),
